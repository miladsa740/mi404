...
def fetch_servers():
    ...
    # دریافت کانفیگ‌ها
    all_servers.extend(fetch_from_url(url1, "url1"))
    all_servers.extend(fetch_from_url(url2, "url2", limit=300))
    all_servers.extend(fetch_from_url(url3, "url3", limit=200))
    all_servers.extend(fetch_from_url(url4, "url4", limit=100))
    all_servers.extend(fetch_from_url(url5, "url5", limit=100))
